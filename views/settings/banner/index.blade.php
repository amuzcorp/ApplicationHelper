...
<table style="display:none;">
    <tr id="ah_banner_template">
        ...
        <td>
            <input type="text" name="slide_time[]" class="form-control" required value="" />
        </td>
        <td>
            <a href="#" class="xe-btn xe-btn-danger-outline" onclick="return removeBannerRow(this)">삭제</a>
        </td>
    </tr>
</table>
    ...
    <div class="panel-group" role="tablist" aria-multiselectable="true">
        <div class="panel">
            ...
            <div class="panel-collapse collapse in">
                <form method="post" action="{{ route('application_helper.settings.configSave',['type' => 'banner']) }}">
                                        ...
                                        <div class="panel">
                                            <div class="table-responsive">
                                                <table class="table">
                                                    ...
                                                    <tr>
                                                        <th scope="col">배너키</th>
                                                        <th scope="col">배너그룹 선택</th>
                                                        <th scope="col">슬라이드 시간</th>
                                                        <th scope="col">기능</th>
                                                    </tr>
                                                    </thead>
                                                    <tbody id="ah_banner_warp">
                                                    <tr>
                                                        <td colspan="3"></td>
                                                        <td>
                                                            <a href="#" onclick="return addBannerRow()" class="xe-btn xe-btn-pimary-outline">추가</a>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    @foreach($ah_banner_groups as $key => $item)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" name="slide_time[]" class="form-control" required value="{{$item['slide_time']}}" />
                                                            </td>
                                                            <td>
                                                                <a href="#" class="xe-btn xe-btn-danger-outline" onclick="return removeBannerRow(this)">삭제</a>
                                                            </td>
...
<script>
    function removeBannerRow(obj){
        $(obj).parent().parent().remove();
    }
    function addBannerRow(){
        let html = "<tr>" + $("#ah_banner_template").html() + "</tr>";
        $("#ah_banner_warp").append(html);
    }
</script>
{{--<script>--}}
