        ...
        <fieldset>
            ...
            <div class="user-login">
                <div class="xu-form-group xu-form-group--large">
                    <input type="text" name="email" class="xu-form-group__control" placeholder="{{ xe_trans('xe::id') }} {{ xe_trans('xe::or') }} {{ xe_trans('xe::email') }}" value="{{ old('email') }}" style="text-transform: lowercase;">
                </div>
                <div class="xu-form-group xu-form-group--large">
