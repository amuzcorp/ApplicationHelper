<?php
namespace Amuz\XePlugin\ApplicationHelper\Skins\DefaultBoard;
...
class DefaultBoard extends CommonSkin
{
    protected static $path = 'ApplicationHelper/src/Skins/DefaultBoard';
    /**
     * @var array
     * @deprecated beta.24.
     */
