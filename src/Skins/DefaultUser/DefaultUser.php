<?php
namespace Amuz\XePlugin\ApplicationHelper\Skins\DefaultUser;

use Xpressengine\Skin\GenericSkin;

class DefaultUser extends GenericSkin
{
    protected static $path = 'ApplicationHelper/src/Skins/DefaultUser/views';
